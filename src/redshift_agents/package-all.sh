...
echo "Next steps:"
echo "1. Upload to S3:"
echo "   aws s3 cp packages/orchestrator-deployment.zip s3://YOUR-BUCKET/orchestrator/"
echo "   aws s3 cp packages/assessment-deployment.zip s3://YOUR-BUCKET/assessment/"
